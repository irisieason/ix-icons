...
With the release of version 3 of the main libraries @irisieason/ix and @irisieason/ix-icons, you now need to provide the icons as a static resource. This significantly reduces the bundle size.
